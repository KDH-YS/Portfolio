...
export function MenuZone({setLeftMenu}){
  return(
    ...
    <ul class="mainmenu">
        <li>
            <a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(1)} }>캠핑장소개</a>
            <ul class="submenu">
        ...
        <li>
            <a href="#"onClick={(event)=>{event.preventDefault(); setLeftMenu(2)} }>사이트보기</a>
            <ul class="submenu">
                <li><a href="#"onClick={(event)=>{event.preventDefault(); setLeftMenu(2)} }>시설물보기</a></li>
            </ul>
        </li>
        <li>
            <a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(3)} }>예약안내</a>
            <ul class="submenu">
        ...
        <li>
            <a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(4)} }>특별함</a>
            <ul class="submenu">
                <li><a href ="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(4)} }>특별함</a></li>
            </ul>
        </li>
        <li>
            <a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(5)} }>인기여행지</a>
            <ul class="submenu">
                <li><a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(5)} }>인근여행지</a></li>
            </ul>
        </li>
        <li>
            <a href="#" onClick={(event)=>{event.preventDefault(); setLeftMenu(6)} }>커뮤니티</a>
            <ul class="submenu">
